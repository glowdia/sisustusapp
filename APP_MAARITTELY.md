# Sisustusapp - vaatimusmäärittely ja toteutuskuvaus
...
- PDF-export toimii luotettavasti
- editorin perustoiminnot toimivat ilman kriittisiä bugeja
- tyylitestin ensimmäinen versio toimii
- AI-tulkinta toimii server-puolen API:n kautta
- sovellus on julkaistu Verceliin
- ympäristömuuttujat on dokumentoitu
- projektissa on selkeä jatkokehitysdokumentaatio
